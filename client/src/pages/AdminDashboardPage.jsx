        ...
        <div className={`${styles.dashboardContainer} container`}>
            ...
            <div className={styles.managementSection}>
                ...
                <div className={styles.managementGrid}>
                    ...
                    <Link to="/admin/eventos" className={`${styles.managementCard} card`}>
                        <div><h3>Gestionar Eventos</h3><p>Administrar salones, arriendos y disponibilidad.</p></div>
                        <ArrowIcon />
                    </Link>
                    <Link to="/admin/promociones" className={`${styles.managementCard} card`}>
                        <div><h3>Gestionar Promociones</h3><p>Crear y administrar códigos de descuento.</p></div>
                        <ArrowIcon />
                    </Link>
                    <Link to="/admin/restaurant" className={`${styles.managementCard} card`}>
                        <div><h3>Gestión de Restaurant</h3><p>Controla proveedores, categorías y stock de insumos.</p></div>
                        <ArrowIcon />
                    </Link>
