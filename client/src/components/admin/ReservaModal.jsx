...
// --- ELIMINADAS TODAS LAS REFERENCIAS A MONGOOSE O FUNCIONES `getModel` ---
// Estas son herramientas de backend y no pertenecen al código de React/frontend.
...
const ReservaModal = ({ show, onClose, onSave, reserva }) => {
    ...
    const validateField = useCallback((name, value) => {
        ...
        } else if (name === 'fecha_fin' && formData.fecha_inicio && value <= formData.fecha_inicio) {
        ...
        <div className={styles.modalOverlay}>
            <div className={styles.modalContent}>
                ...
                <form onSubmit={handleSubmit}>
                    {/* --- Paso 1: Selección de Cliente y Habitación --- */}
                    {currentStep === 1 && (
